...
int main() {
    ...
    for (i = 0; i < 5; i++) {
        ...
        for (j = 0; j < 3; j++) {
            ...
            do {
                printf("  Pon la nota %d (de 0 a 10): ", j + 1);
    ...
    printf("----RESULTADOS POR CADA ESTUDIANTE----\n");
    ...
    for (i = 0; i < 5; i++) {
        ...
        printf("Estudiante %d (sus 3 notas):\n", i + 1);
        printf("Su promedio es: %.2f\n", promedio);
        printf("Su nota más alta fue: %.2f\n", mayor);
        printf("Su nota más baja fue: %.2f\n", menor);
    }
    
    printf("--- RESULTADOS POR CADA ASIGNATURA ---\n");
